        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center mb-24">
          ...
          <div className="order-2 lg:order-1">
            <div className="relative group">
              ...
              <div className="relative aspect-[4/5] rounded-2xl overflow-hidden flex items-center justify-center">
                <img src={About} className="w-100 rounded-2xl pb-30 grayscale-100" alt="" srcSet="" />
                  ...
                  <div className="bg-black/60 backdrop-blur-xl border border-white/10 rounded-xl p-5">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p
                          className="text-white/70 text-xs tracking-wider mt-1"
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div className="relative">
              <div className="absolute -left-4 top-0 text-6xl text-teal-400/20 font-serif">
                "
              </div>
              <p
