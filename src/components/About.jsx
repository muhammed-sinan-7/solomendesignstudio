...
const AboutSection = () => {
  return (
    <>
      {/* SEO Meta Tags */}
      <Helmet>
        <title>About Solomen Design Studio - 9+ Years Design Experience Dubai</title>
        <meta 
          name="description" 
          content="Solomen Design Studio brings over 9 years of professional design experience in branding, UI/UX, social media graphics, and print design in Dubai. 200+ digital products delivered." 
        />
        <meta 
          name="keywords" 
          content="solomen design studio, graphic designer dubai, branding agency dubai, UI UX designer, logo design dubai, print design, packaging design, social media design" 
        />
        <link rel="canonical" href="https://www.solomendesigns.com/" />
        
        {/* Open Graph Tags */}
        <meta property="og:title" content="About Solomen Design Studio - Design That Speaks Volumes" />
        <meta property="og:description" content="9+ years of design excellence in branding, UI/UX, and digital products. Based in Dubai." />
        <meta property="og:image" content="https://yourwebsite.com/assets/smile.png" />
        <meta property="og:url" content="https://yourwebsite.com/about" />
        <meta property="og:type" content="website" />
        
        {/* Twitter Card Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="About Solomen Design Studio" />
        <meta name="twitter:description" content="9+ years of design excellence in branding, UI/UX, and digital products" />
        <meta name="twitter:image" content="https://yourwebsite.com/assets/smile.png" />
      ...
      <section className="relative bg-black text-white py-20 sm:py-24 md:py-32 lg:py-40 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          {/* Centered Header - Using Semantic HTML */}
          <header className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <h2 
              className="text-white sm:text-5xl md:text-7xl font-bold lg:text-7xl"
          ...
          <article className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 md:gap-16 lg:gap-20 items-center mb-16 sm:mb-20 md:mb-24">
              ...
              <div className="relative group max-w-lg mx-auto lg:max-w-none">
                ...
                <div className="relative aspect-[4/5] rounded-2xl overflow-hidden bg-neutral-900">
                  <img 
                    ...
                    alt="Solomen Design Studio founder - Professional graphic designer with 9 years experience in Dubai specializing in branding and UI/UX design"
                    loading="eager"
                    width="800"
                    height="1000"
                  />
                  ...
                  <aside className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6">
            ...
            <div className="order-2 lg:order-2 space-y-6 sm:space-y-8">
              ...
              <blockquote className="relative">
                <div className="absolute -left-2 sm:-left-4 top-0 text-4xl sm:text-5xl md:text-6xl text-teal-400/20 font-serif" aria-hidden="true">
                  "
                </div>
                <p
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                >
                  With over <strong>8 years of experience</strong> in crafting visually stunning designs, <strong>Solomen Design Studio</strong> is your one-stop-shop for all your branding needs. From logos that pop to social media graphics that spark conversations, our team of experts excels in bringing your vision to life.
                </p>
                ...
                >
                  We breathe life into brands through thoughtful <strong>UI design</strong>, captivating <strong>print collaterals</strong>, and <strong>packaging</strong> that stands out.
                </p>
              ...
              <nav className="pt-2 sm:pt-4">
                <a
                  ...
                  aria-label="View Solomen Design Studio portfolio and projects"
                >
                  <span
