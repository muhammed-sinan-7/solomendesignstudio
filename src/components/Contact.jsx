  ...
  return (
    <div>
      ...
      <section className="relative bg-black text-white py-32 md:py-40 overflow-hidden">
        ...
        {/* Subtle Gray Accent */}
        <div className="absolute bottom-0 left-1/4 w-[600px] h-[600px] bg-neutral-800/20 rounded-full blur-[150px] pointer-events-none"></div>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="group relative">
                  <div className="relative bg-neutral-900/30 border border-neutral-800/50 rounded-xl p-6 hover:border-neutral-700/50 transition-all duration-300">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-lg bg-neutral-800/50 border border-neutral-700/50 flex items-center justify-center flex-shrink-0">
              ...
              <div className="mt-12">
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    className="w-12 h-12 rounded-lg bg-neutral-900/30 border border-neutral-800/50 hover:border-neutral-700/50 flex items-center justify-center transition-all duration-300 hover:scale-110"
                  >
                    <svg className="w-5 h-5 text-neutral-300" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M22 7h-7v7h7V7zm-8 0h-7v7h7V7zm8 8h-7v7h7v-7zm-8 0h-7v7h7v-7z"/>
                    </svg>
                  </a>
                  <a
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-neutral-900/30 border border-neutral-800/50 rounded-lg text-white placeholder-neutral-600 focus:outline-none focus:border-neutral-700/50 transition-colors"
                    style={{ fontFamily: "'Raleway', sans-serif" }}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows="6"
                    className="w-full px-4 py-3 bg-neutral-900/30 border border-neutral-800/50 rounded-lg text-white placeholder-neutral-600 focus:outline-none focus:border-neutral-700/50 transition-colors resize-none"
                    style={{ fontFamily: "'Raleway', sans-serif" }}
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-4 bg-gradient-to-r from-neutral-800 to-neutral-700 border-2 border-neutral-700 rounded-lg text-white font-semibold tracking-wide hover:border-neutral-600 hover:scale-[1.02] transition-all duration-300 flex items-center justify-center gap-3 group"
