        ...
        <div className="container mx-auto px-6 max-w-7xl py-16 md:py-20">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              >
                A passionate graphic designer crafting meaningful visual experiences across branding, digital design, and print media.
              </p>
          ...
          <div className="container mx-auto px-6 max-w-7xl py-6">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <p
                ...
                style={{ fontFamily: "'TASA Explorer', sans-serif" }}
              >
                © {currentYear} All rights reserved. Designed & Developed with passion.
              </p>
